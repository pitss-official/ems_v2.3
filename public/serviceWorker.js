...
var cacheName = 'svc1'; // Call Install Event
...
self.addEventListener('fetch', function (e) {
  ...
  e.respondWith(fetch(e.request).then(function (res) {
    ...
    caches.open(cacheName).then(function (cache) {
      ...
      cache.put(e.request, resClone)["catch"](function (reason) {
        console.log(cache);
      });
    });
    return res;
...
module.exports = __webpack_require__(/*! G:\ems_v2.3\resources\js\serviceWorker.js */"./resources/js/serviceWorker.js");
