...
<script>
    export default {
        ...
        methods:{
          getChats(){
              axios.get('/api/chat').then(res=>this.$data.chatList=res.data)
          },
          setChat(c){
              this.$data.selectedChat=c;
          }
        },
        mounted() {
            this.getChats();
